"""
🌐 Website Scraper Module - FIXED NameError
========================
Handles website scraping, staff extraction, and LinkedIn URL discovery
✅ FIXED: page_function NameError - now uses correct variable name
"""
...
"""
        ...
        payload = {
            "startUrls": [{"url": url}],
            "maxPagesPerRun": 1,
            "pageFunction": mapping_function,  # ✅ FIXED: was page_function, now mapping_function
...
Focus on: about, team, staff, people, contact, leadership pages."""
    ...
    def _analyze_single_url(self, url: str) -> tuple:
        ...
        # Clean JavaScript function - FIXED: Now uses correct variable name
        page_function = """
        async function pageFunction(context) {
            const { request, log, jQuery } = context;
            const $ = jQuery;
        ...
        payload = {
            "startUrls": [{"url": url}],
            "maxPagesPerRun": 1,
            "pageFunction": page_function,  # ✅ FIXED: This one is correct now
            "proxyConfiguration": {"useApifyProxy": True}
        }
