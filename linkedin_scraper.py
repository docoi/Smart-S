"""
🔗 LinkedIn Scraper Module - COMPLETE CORRECTED VERSION
========================================================
Fixed all issues: method names, company filtering, URL formatting, and business owner detection
"""
...
class LinkedInScraper:
    ...
    def _native_scrape_linkedin_actor2(self, linkedin_url: str, domain: str) -> list:
        ...
        try:
            ...
            client = manager.get_working_apify_client_part2()  # ✅ CORRECTED METHOD NAME
            
            # Convert LinkedIn URL to proper format for actors - ADDED URL FORMATTING
            ...
            actor_input = {
                "companies": [formatted_linkedin_url],  # ✅ Use formatted URL
                "maxItems": 30,
                "mode": "full_email",
                "includeEmails": True,
                "timeout": 120
            ...
            for item in items:
                try:
                    ...
                    # ✅ ADDED: Smart company filtering - Include owners/founders, filter external employees
